...
myModel.save('./saves/myModelTestingV1')

print(f"Training Loss: {history.history['loss']}\nTraining Acc: {history.history['accuracy']}\nVal Loss: {history.history['val_loss']}\n Val Acc: {history.history['val_accuracy']}")

plotLossAndAccuracy(history.history['loss'], history.history['accuracy'], history.history['val_loss'], history.history['val_accuracy'])
